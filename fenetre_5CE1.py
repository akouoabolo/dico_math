...
image_f5 = ImageTk.PhotoImage(Image.open("pub13.png"))
...
reponse_entry1_f5.place(x=770, y=455)

reponse_entry2_f5=tkinter.Label(fenetre5,text="")
reponse_entry2_f5.place(x=930, y=500)

reponse_entry3_f5=tkinter.Label(fenetre5,text="")
reponse_entry3_f5.place(x=660, y=615)


reponse_entry4_f5=tkinter.Label(fenetre5,text="")
reponse_entry4_f5.place(x=866, y=660)
...
# Create question 1
question1_label_f5 = tkinter.Label(fenetre5, text="1- Les abreuvoirs ont la forme de quels solide ?", font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left")
question1_label_f5.place(x=0, y=0, relx=0.37, rely=0.63, anchor="center")

entry1_f5 = tkinter.Entry(reponse_entry1_f5, font=("Comic sans Ms", 18, ""), width=10, highlightthickness=1, highlightbackground="orange")
entry1_f5.pack()
...
question2_label_f5 = tkinter.Label(fenetre5, text="2- Peut-on fabriquer des abreuvoirs sous frome cylindriques ?",  font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left")
question3_label_f5 = tkinter.Label(fenetre5, text="3- Supposons que les abreuvoirs fassent 2 mètres de haut,\n que se passera-t-il ? \n l'eau déborde - trop haut - trop bas", font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left")
...
question2_label_f5.place(x=0, y=0, relx=0.43, rely=0.69, anchor="center")
question3_label_f5.place(x=0, y=0, relx=0.416, rely=0.80, anchor="center")
question4_label_f5.place(x=0, y=0, relx=0.405, rely=0.91, anchor="center")

entry2_f5 = tkinter.Entry(reponse_entry2_f5, font=("Comic sans Ms", 18, ""), width=6, highlightthickness=1, highlightbackground="orange")
entry2_f5.pack()



#question2b_label.pack()
entry3_f5 = tkinter.Entry(reponse_entry3_f5, font=("Comic sans Ms", 18, ""), width=10, highlightthickness=1, highlightbackground="orange")
entry3_f5.pack()
...
entry4_f5 = tkinter.Entry(reponse_entry4_f5, font=("Comic sans Ms", 18, ""), width=10, highlightthickness=1, highlightbackground="orange")
entry4_f5.pack()
...
label_text_f5 = tkinter.Label(fenetre5, text="Monsieur Tamo posséde dans sa ferme : \n ", font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left")
label_text2_f5 = tkinter.Label(fenetre5, text="Chaque jour, ces animaux consomment 285 kg de nourriture. ", font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left")
...
btn_quitter_f5 = customtkinter.CTkButton(fenetre5, text="Quitter", font=("Comic Sans Ms", 16), command=fenetre5.destroy)

# Position other widgets
label_text_f5.place(x=0, y=0, relx=0.34, rely=0.15, anchor="center")
label_text2_f5.place(x=0, y=0, relx=0.43, rely=0.56, anchor="center")
#btn_quitter_f5.place(x=1050, y=680)
