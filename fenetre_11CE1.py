...
def clear_entries_f4():
    entry1_0f4.delete(0, 'end')
    entry1_1f4.delete(0, 'end')
    entry1_2f4.delete(0, 'end')
    ...
    label_acess_f4.place_forget() # masquer les widgets sans pour autant détruire leur context!
...
reponse_entry2_f4.place(x=225, y=200)

reponse_entry3_f4=tkinter.Label(fenetre4,text="")
reponse_entry3_f4.place(x=930, y=415)


reponse_entry4_f4=tkinter.Label(fenetre4,text="")
reponse_entry4_f4.place(x=425, y=599)
...
entry2_f4 = tkinter.Entry(reponse_entry2_f4, font=("Comic sans Ms", 18, ""), width=6,highlightthickness=1, highlightbackground="orange")
#entry2_f4.pack()
...
entry4_f4 = tkinter.Entry(reponse_entry4_f4, font=("Comic sans Ms", 18, ""), width=10,highlightthickness=1, highlightbackground="orange")
entry4_f4.pack()
