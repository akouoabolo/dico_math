...
image_f2 = ImageTk.PhotoImage(Image.open("back_5.png"))

img_f2 = ImageTk.PhotoImage(Image.open("max27.png"))
img1_f2 = ImageTk.PhotoImage(Image.open("74.png"))

mon_label_img_f2=tkinter.Label(fenetre5, image=img, bg="#EAAC14")
mon_label_img1_f2=tkinter.Label(fenetre5, image=img1, bg="#EAAC14")
#mon_label_img.pack()

background_label_f2 = tkinter.Label(fenetre5, image=image_f2)
background_label_f2.place(x=0, y=0, relwidth=1, relheight=1)

label_acess_f2 = tkinter.Label(fenetre5, fg='white')
label_denied_f2 = tkinter.Label(fenetre5, fg='#AA2822')
# Create a frame for the exercise
#exercise_frame = tkinter.LabelFrame(fenetre, text="")
#exercise_frame.place(x=300, y=200)

reponse_entry1_f2=tkinter.Label(fenetre5,text="")
reponse_entry1_f2.place(x=348, y=434)

reponse_entry2_f2=tkinter.Label(fenetre5,text="")
reponse_entry2_f2.place(x=560, y=434)

reponse_entry3_f2=tkinter.Label(fenetre5,text="")
reponse_entry3_f2.place(x=793, y=434)


reponse_entry4_f2=tkinter.Label(fenetre5,text="")
reponse_entry4_f2.place(x=210, y=470)


reponse_entry5_f2=tkinter.Label(fenetre5,text="")
reponse_entry5_f2.place(x=460, y=470)


reponse_entry6_f2=tkinter.Label(fenetre5,text="")
reponse_entry6_f2.place(x=675, y=469)


reponse_entry7_f2=tkinter.Label(fenetre5,text="")
reponse_entry7_f2.place(x=530, y=570)

reponse_entry8_f2=tkinter.Label(fenetre5,text="")
reponse_entry8_f2.place(x=600, y=620)
...
# Create question 1
question1_label_f2 = tkinter.Label(fenetre5, text="1- Il a vendu [______] tenues + [______] tableaux + [______] perles + \n [______]  bracelets + _____ masques =  ",font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left")#FDFBFB",justify="left")
question1_label_f2.place(x=0, y=0, relx=0.45, rely=0.63, anchor="center")

entry1_f2 = tkinter.Entry(reponse_entry1_f2, font=("Comic sans Ms", 18, ""), width=7,highlightthickness=1, highlightbackground="orange")
entry1_f2.pack()
...
question2_label_f2 = tkinter.Label(fenetre5, text="2- Quel est le nombre total des masques ? \n Ecris ce nombre en lettre :",  font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left")
question3_label_f2 = tkinter.Label(fenetre5, text="3- Quel est l'objet le plus vendu ?", font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left" )
question4_label_f2 = tkinter.Label(fenetre5, text="4- Combien d'animaux possède Monsieur Tamo au total ?", font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left")


#question2_label.place(x=0, y=0, relx=0.385, rely=0.63, anchor="center")
question2_label_f2.place(x=0, y=0, relx=0.33, rely=0.76, anchor="center")
question3_label_f2.place(x=0, y=0, relx=0.296, rely=0.86, anchor="center")
#question4_label_f2.place(x=0, y=0, relx=0.405, rely=0.91, anchor="center")

entry2_f2 = tkinter.Entry(reponse_entry2_f2, font=("Comic sans Ms", 18, ""), width=7,highlightthickness=1, highlightbackground="orange")
entry2_f2.pack()



#question2b_label.pack()
entry3_f2 = tkinter.Entry(reponse_entry3_f2, font=("Comic sans Ms", 18, ""), width=7,highlightthickness=1, highlightbackground="orange")
entry3_f2.pack()
...
entry4_f2 = tkinter.Entry(reponse_entry4_f2, font=("Comic sans Ms", 18, ""), width=7,highlightthickness=1, highlightbackground="orange")
entry4_f2.pack()
...
check_button_f2 = customtkinter.CTkButton(fenetre5, text="Vérifier les réponses", font=("Comic Sans Ms", 16), command=check_answers)
check_button_f2.place(x=1050, y=380)

# Create other widgets
label_text_f2 = tkinter.Label(fenetre5, text="Quel est le nombres d'objets vendus en janvier ? \nPour trouver la réponse complète l'égalité : \n ", font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left")
...
btn_quitter_f2 = customtkinter.CTkButton(fenetre5, text="Quitter", font=("Comic Sans Ms", 16), command=fenetre5.destroy)
...
bouton_precedent = customtkinter.CTkButton(fenetre5, text="Précédent", command=precedent, width=3, font=("Comic Sans Ms", 16))
...
bouton_suivant = customtkinter.CTkButton(fenetre5, text="Suivant", command=suivant, width=3, font=("Comic Sans Ms", 16))
...
reset_img_label_f2=tkinter.Label(fenetre5, image=reset_img_f2)
 
# Create a button to clear the entries
clear_button_f2 = tkinter.Button(fenetre5, command=clear_entries_f2, image=reset_img_f2, bg="white", borderwidth=0, cursor="hand2" )
...
reponse_entry1_f2.lift()
reponse_entry2_f2.lift()
reponse_entry3_f2.lift()
reponse_entry4_f2.lift()
reponse_entry5_f2.lift()
reponse_entry6_f2.lift()
reponse_entry7_f2.lift()
reponse_entry8_f2.lift()
