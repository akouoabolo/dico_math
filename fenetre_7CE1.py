...
image_f7= ImageTk.PhotoImage(Image.open("back_5.png"))
...
# Create question 1
question1_label_f7 = tkinter.Label(fenetre7, text="1- Quel est le nom de la forme géométrique de ce tableau ?  ",font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left")
...
question1_label_f7.place(x=0, y=0, relx=0.42, rely=0.60, anchor="center")
...
question2_label_f7 = tkinter.Label(fenetre7, text="2- Quelles sont ses dimensions en longueur et en largeur ? \n Ecris ces nombres en lettre:\n La longueur: \t\t la largeur:",  font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left")
...
question2_label_f7.place(x=0, y=0, relx=0.414, rely=0.73, anchor="center")
...
entry2_f7 = tkinter.Entry(reponse_entry2_f7, font=("Comic sans Ms", 18, ""), width=13,highlightthickness=1, highlightbackground="orange")
entry2_f7.pack()



#question2b_label.pack()
entry3_f7 = tkinter.Entry(reponse_entry3_f7, font=("Comic sans Ms", 18, ""), width=13,highlightthickness=1, highlightbackground="orange")
entry3_f7.pack()
...
label_text_f7 = tkinter.Label(fenetre7, text="Observe à nouveau le tableau du musée ci-dessous: \n ", font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left")

# Position other widgets
label_text_f7.place(x=0, y=0, relx=0.34, rely=0.15, anchor="center")
...
clear_button_f7 = tkinter.Button(fenetre7, command=clear_entries_f2, image=reset_img_f7, bg="white", borderwidth=0, cursor="hand2" )
