...
mon_label_img_f12=tkinter.Label(fenetre12, image=img_f12, bg="#EAAC14")
mon_label_img1_f12=tkinter.Label(fenetre12, image=img1_f12, bg="#EAAC14")
#mon_label_img.pack()
...
reponse_entry1_f12.place(x=558, y=170)

reponse_entry2_f12=tkinter.Label(fenetre12,text="")
reponse_entry2_f12.place(x=600, y=215)

reponse_entry3_f12=tkinter.Label(fenetre12,text="")
reponse_entry3_f12.place(x=650, y=315)


reponse_entry4_f12=tkinter.Label(fenetre12,text="")
reponse_entry4_f12.place(x=695, y=680)
...
reponse_entry6_f110=tkinter.Label(fenetre12,text="")
reponse_entry6_f110.place(x=866, y=650)


reponse_entry7_f110=tkinter.Label(fenetre12,text="")
reponse_entry7_f110.place(x=530, y=570)
reponse_entry8_f110=tkinter.Label(fenetre12,text="")
...
# Create question 1
question1_label_f12 = tkinter.Label(fenetre12, text="1- Give the geometric coordinates of points A, B and C on the diagram:  ",font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left")
...
question1_label_f12.place(x=0, y=0, relx=0.41, rely=0.75, anchor="center")
...
question2_label_f12 = tkinter.Label(fenetre12, text="2- Quelle est Le nombre total de passagers \ntransportés ce jour là ? : ",  font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left")
question3_label_f12 = tkinter.Label(fenetre12, text="3- Quelle serait la distance, si nous avions \n le double de la distance actuelle parcourue ?   ", font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left" )
question4_label_f12 = tkinter.Label(fenetre12, text="4- Regardez les chiffres ci-dessus ! \nCombien d’élèves y a-t-il dans le cercle A ?", font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left")
...
# Create question 3
question4_labe_f12 = tkinter.Label(fenetre12, text="3- Trouvez les données parasites pour ce problème:", font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left")
...
label_text_f12 = tkinter.Label(fenetre12, text="Observez la réparation ci-dessus et répondez à la question suivante :", font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left")
...
label_text_f12.place(x=0, y=0, relx=0.40, rely=0.14, anchor="center")
