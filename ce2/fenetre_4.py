...
def clear_entries_f4():
    entry1_f4.delete(0, 'end')
    entry2_f4.delete(0, 'end')
    entry3_f4.delete(0, 'end')
    entry4_f4.delete(0, 'end')
...
def check_answers():
    answer1_f4 = entry1_f4.get().strip()
...
image_f4 = ImageTk.PhotoImage(Image.open("font4.png"))
...
reponse_entry1_f4.place(x=450, y=505)

reponse_entry2_f4=tkinter.Label(fenetre4,text="")
reponse_entry2_f4.place(x=470, y=620)

reponse_entry3_f4=tkinter.Label(fenetre4,text="")
reponse_entry3_f4.place(x=870, y=505)


reponse_entry4_f4=tkinter.Label(fenetre4,text="")
reponse_entry4_f4.place(x=870, y=620)
...
# Create question 1
question1_label_f4 = tkinter.Label(fenetre4, text="1- l'angle plat :  ",font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left")
...
question1_label_f4.place(x=0, y=0, relx=0.27, rely=0.70, anchor="center")

entry1_f4 = tkinter.Entry(reponse_entry1_f4, font=("Comic sans Ms", 18, ""), width=7,highlightthickness=1, highlightbackground="orange")
entry1_f4.pack()
...
question2_label_f4.place(x=0, y=0, relx=0.274, rely=0.85, anchor="center")
question3_label_f4.place(x=0, y=0, relx=0.567, rely=0.70, anchor="center")
question4_label_f4.place(x=0, y=0, relx=0.561, rely=0.85, anchor="center")

entry2_f4 = tkinter.Entry(reponse_entry2_f4, font=("Comic sans Ms", 18, ""), width=7,highlightthickness=1, highlightbackground="orange")
entry2_f4.pack()


#question2b_label.pack()
entry3_f4 = tkinter.Entry(reponse_entry3_f4, font=("Comic sans Ms", 18, ""), width=7,highlightthickness=1, highlightbackground="orange")
entry3_f4.pack()
...
entry4_f4 = tkinter.Entry(reponse_entry4_f4, font=("Comic sans Ms", 18, ""), width=7,highlightthickness=1, highlightbackground="orange")
entry4_f4.pack()
...
label_text_f4 = tkinter.Label(fenetre4, text="Observe les figures ci-dessous et entre la lettre correspondant\n à l'angle . ", font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left")
