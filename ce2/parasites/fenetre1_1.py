...
image_f8 = ImageTk.PhotoImage(Image.open("couv.png"))
...
reponse_entry1_f8.place(x=450, y=429)

reponse_entry2_f8=tkinter.Label(fenetre8,text="")
reponse_entry2_f8.place(x=870, y=429)

reponse_entry3_f8=tkinter.Label(fenetre8,text="")
reponse_entry3_f8.place(x=470, y=510)
...
question2_label_f8 = tkinter.Label(fenetre8, text="2- L'angle droit : ",  font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left")
question3_label_f8 = tkinter.Label(fenetre8, text="3- L'angle obtus :", font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left" )
question4_label_f8 = tkinter.Label(fenetre8, text="4- Langle aigu : ", font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left")
...
label_text_f8.place(x=0, y=0, relx=0.43, rely=0.15, anchor="center")
