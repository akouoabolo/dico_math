...
def reset_exercise():
    ...
    user_input.set("")
    result_label.set("")
    label_instruction.config(text=f"Convertir {random_number} grammes en:", font=("Comic Sans Ms",20, "bold"), bg="#EAAC14")
    label_instruction.place(x=0,y=0)
...
label_instruction = tkinter.Label(fenetre6, text=f"Convertir {random_number} grammes en:",  font=("Comic Sans Ms",20, "bold"), bg="#EAAC14")
label_instruction.place(x=0, y=0)
...
checkbox_kg = tkinter.Checkbutton(fenetre6, text="Kilogramme", variable=checkbox_var_kg)
checkbox_hg = tkinter.Checkbutton(fenetre6, text="Hectogramme", variable=checkbox_var_hg)
checkbox_dag = tkinter.Checkbutton(fenetre6, text="Decagramme", variable=checkbox_var_dag)
checkbox_g = tkinter.Checkbutton(fenetre6, text="Gramme", variable=checkbox_var_g)

label_user_input = tkinter.Label(fenetre6, text="Entrez la conversion:")
entry_user_input = tkinter.Entry(fenetre6, textvariable=user_input)
...
reponse_entry1_f6.place(x=450, y=429)
