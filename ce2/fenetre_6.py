...
def generate_numbers():
    ...
    if label_numbers is None:
        label_numbers = tkinter.Label(fenetre6, text="")
...
mon_label_img1_f6=tkinter.Label(fenetre6, image=img1_f6, bg="#EAAC14", font=("Comic sans Ms", 18, ""),justify="left")
#mon_label_img.pack()
...
label_operation = tkinter.Label(fenetre6, text="Choisir l'opération:",font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left")
checkbox_addition = tkinter.Checkbutton(fenetre6, text="Addition", variable=operation_addition,font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left")
checkbox_soustraction = tkinter.Checkbutton(fenetre6, text="Soustraction", variable=operation_soustraction,font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left")
checkbox_multiplication = tkinter.Checkbutton(fenetre6, text="Multiplication", variable=operation_multiplication,font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left")
checkbox_division = tkinter.Checkbutton(fenetre6, text="Division", variable=operation_division ,font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left")
...
# Créer les éléments d'interface utilisateur
label_numbers = tkinter.Label(fenetre6, text=f"Effectue les opérations sur les nombres suivant: \n\n Nombre1 : {num1}\tNombre2 : {num2}", font=("Comic Sans Ms",18, ""), bg="#FDFBFB",justify="left")
label_numbers.place(x=300, y=80)

label_entry_answer = tkinter.Label(fenetre6, text="Entrez le résultat:", font=("Comic Sans Ms",18, ""), bg="#FDFBFB",justify="left")
entry_answer  = tkinter.Entry(fenetre6, textvariable=user_input, font=("Comic Sans Ms",18, ""), bg="#FDFBFB",justify="left",highlightthickness=1, highlightbackground="orange")
...
bouton_suivant = customtkinter.CTkButton(fenetre6, text=">>", command=suivant, width=3, font=("Comic Sans Ms", 19,"bold"))
