...
def clear_entries_f2():
    ...
    label_acess_f8.place_forget() # masquer les widgets sans pour autant détruire leur context!
...
def check_answers():
    ...
    answer5_f8 = entry5_f8.get().strip()
...
image_f8 = ImageTk.PhotoImage(Image.open("font9_.png"))

img_f8 = ImageTk.PhotoImage(Image.open("max27.png"))
img1_f8 = ImageTk.PhotoImage(Image.open("74.png"))

mon_label_img_f8=tkinter.Label(fenetre8, image=img_f8, bg="#EAAC14")
mon_label_img1_f8=tkinter.Label(fenetre8, image=img1_f8, bg="#EAAC14")
#mon_label_img.pack()
background_label_f6 = tkinter.Label(fenetre8, image=image_f8)
...
reponse_entry1_f8.place(x=588, y=427)

reponse_entry2_f8=tkinter.Label(fenetre8,text="")
reponse_entry2_f8.place(x=355, y=545)

reponse_entry3_f8=tkinter.Label(fenetre8,text="")
reponse_entry3_f8.place(x=590, y=545)


reponse_entry4_f8=tkinter.Label(fenetre8,text="")
reponse_entry4_f8.place(x=838, y=545)
...
# Create question 1
question1_label_f8 = tkinter.Label(fenetre8, text="1- Du plus petit au plus grand :  ",font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left")
...
question1_label_f8.place(x=0, y=0, relx=0.31, rely=0.60, anchor="center")

entry1_f8 = tkinter.Entry(reponse_entry1_f8, font=("Comic sans Ms", 18, ""), width=18,highlightthickness=1, highlightbackground="orange")
entry1_f8.pack()
...
question2_label_f8 = tkinter.Label(fenetre8, text="2- Saisie le résultat des opérations suivantes :\n 243x3 = \t\t 106x5 = \t\t 475+34= ",  font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left")
question3_label_f8 = tkinter.Label(fenetre8, text="3- Pour entouré le musée, Mbarga pense qu'il faut utiliser l'aire et \n Kambouo pense au périmetre. lequel des deux a raison ?", font=("Comic sans Ms", 18, ""),bg="#FDFBFB",justify="left" )
...
question2_label_f8.place(x=0, y=0, relx=0.40, rely=0.73, anchor="center")
question3_label_f8.place(x=0, y=0, relx=0.444, rely=0.87, anchor="center")
...
entry5_f8 = tkinter.Entry(reponse_entry5_f8, font=("Comic sans Ms", 18, ""), width=7,highlightthickness=1, highlightbackground="orange")
entry5_f8.pack()
...
label_text_f8.place(x=0, y=0, relx=0.46, rely=0.15, anchor="center")
...
bouton_precedent = customtkinter.CTkButton(fenetre8, text="<<", command=precedent, width=3, font=("Comic Sans Ms", 19,"bold"))
bouton_precedent.place(x=1049, y=698)

bouton_suivant = customtkinter.CTkButton(fenetre8, text=">>", command=suivant, width=3, font=("Comic Sans Ms", 19,"bold"))
bouton_suivant.place(x=1100, y=698)

#bouton de reset

reset_img_f8=ImageTk.PhotoImage(Image.open("reset_2.png"))
reset_img_label_8=tkinter.Label(fenetre8, image=reset_img_f8)
 
# Create a butt8.place(x=1290, y=0)
# Create a button to clear the entries
clear_button_f8 = tkinter.Button(fenetre8, command=clear_entries_f2, image=reset_img_f8, bg="white", borderwidth=0, cursor="hand2" )
...
label_acess_f8.lift()
label_denied_f8.lift()
mon_label_img_f8.lift()
mon_label_img1_f8.lift()

label_text_f8.lift()

check_button_f8.lift()
reponse_entry1_f8.lift()
reponse_entry2_f8.lift()
reponse_entry3_f8.lift()
reponse_entry4_f8.lift()
reponse_entry5_f8.lift()
reponse_entry6_f8.lift()
#reponse_entry7_f7.lift()
reponse_entry8_f8.lift()
