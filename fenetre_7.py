...
mon_label_img_f7=tkinter.Label(fenetre7, image=img, bg="#EAAC14")
mon_label_img1_f7=tkinter.Label(fenetre7, image=img1, bg="#EAAC14")
#mon_label_img.pack()
background_label_f6 = tkinter.Label(fenetre7, image=image_f7)
...
reponse_entry7_f2=tkinter.Label(fenetre7,text="")
